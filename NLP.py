...
dataset = pd.read_csv('Restaurant_Reviews.tsv',delimiter= '\t',quoting=3)    #ignores tab and quotes
import re 
import nltk
...
from sklearn.feature_extraction.text import CountVectorizer   #to make a sparse matrix
...
from sklearn.metrics import confusion_matrix    #For testing the accuracy
